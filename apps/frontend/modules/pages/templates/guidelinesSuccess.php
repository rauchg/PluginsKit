<div class="block">
	<h3><span>Plugin Writing Guidelines</span></h3>
	
	<div class="block">
		<p>Follow these guidelines to ensure your plugin success among the community.</p>
	</div>
	
	<ol>		
		<li class="block">Your plugin shouldn't do everything on earth. Include the most common options, and let people extend it for extra customization.</li>
